...
return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>du", dapui.open, { desc = "[D]ebug: Open DAP [U]I" })
		vim.keymap.set("n", "<leader>dx", dapui.close, { desc = "[D]ebug: Close DAP UI" })
